        ...
        <div className="flex flex-col justify-between">
          <div>
            <h3 className="text-xl font-bold text-white">
              Odoo 14 Development Cookbook: Rapidly build, customize, and ...
            </h3>
            <p className="text-sm text-[#dbb7a4] mb-2">
              ...
              problems using this guide Key FeaturesLearn to develop new modules
              and modify existing modules using the Odoo ...
            </p>
          </div>
          <div className="text-right">
            <span className="inline-block bg-[#dbb7a4] text-[#3a3e3e] font-bold py-1 px-2 rounded">
              3 Days Remain
            </span>
          </div>
        </div>
